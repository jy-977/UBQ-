<h1 align="center">
  UDL - Embedded and Ubiquitous Systems
</h1>
...
* Prepare the IDE - R.Pi + ChibiOS :three: 3 effort points sprint 2
* Define the checking/test process :five: 5 effort points sprint 2
* How to -> LCD Screen :two: 2 effort points sprint 3 
* How to -> I2C protocol :eight: 8 effort points sprint 3 
* How to -> PCF 8754  :four: 4 effort points sprint 3 
* ESP-01 <-> Arduino interaction :three: 3 effort points sprint 2
* Data Producer 1 development :four:  4 effort points sprint 2
* Data Producer 2 development :four: 4 effort points sprint 2
* Data log and Screen representation :three: 3 effort points sprint 4
* Ultrasonic <-> Led bar representation :five: 5 effort points sprint 4
* R.Pi <-> Arduino interaction :nine: 9 effort points sprint 3
